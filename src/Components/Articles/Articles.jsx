...
const Articles = () => {
  const article_card_info = [
    {
      img: "../Articles/Components/src/assets/images/image-currency.jpg",
    ...
    {
      img: "../Articles/Components/src/assets/images/image-restaurant.jpg",
    ...
    {
      img: "../Articles/Components/src/assets/images/image-plane.jpg",
      user_name:'Claire Robinson',
    ...
    {
      img: "../Articles/Components/src/assets/images/image-confetti.jpg",
      user_name:'Wilson Hutton',
